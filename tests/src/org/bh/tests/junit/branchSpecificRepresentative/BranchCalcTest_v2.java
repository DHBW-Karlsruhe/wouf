...
import org.bh.plugin.branchSpecificRepresentative.calc.BranchSpecificCalculator_v2;
...
public class BranchCalcTest_v2 extends TestCase {
	...
	public void testBranchCalculator() {
		...
		try {
			...
			BranchSpecificCalculator_v2 bsc = new BranchSpecificCalculator_v2();
