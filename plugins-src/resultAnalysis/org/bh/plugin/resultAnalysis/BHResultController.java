...
public class BHResultController extends OutputController{
    ...
    public Map<String, Calculable> getMap(DTOScenario scenario){
    	...
    	if(scenario.getDCFMethod().getUniqueId().equals("apv")){
    		...
    		formulaMap.put("srFK", result.get("org.bh.plugin.apv.APVCalculator$Result. PRESENT_VALUE_TAX_SHIELD[t+1]")[1]);
    		...
    		formulaMap.put("GKt", result.get("org.bh.plugin.fcf.FCFCalculator$Result.TOTAL_CAPITAL [t+1]")[1]);
    		formulaMap.put("FCFT", result.get("org.bh.calculation.IShareholderValueCalculator$ Result.FREE_CASH_FLOW[t+1]")[1]);
    		...
    		formulaMap.put("UWt", result.get("org.bh.calculation.IShareholderValueCalculator$ Result. SHAREHOLDER_VALUE [t+1]")[1]);
