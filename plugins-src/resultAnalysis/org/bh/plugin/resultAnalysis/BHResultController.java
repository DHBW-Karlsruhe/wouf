        ...
        if (scenario.isIntervalArithmetic()) {
            ...
            for (String chartKey : super.view.getBHchartComponents().keySet()) {
                ...
                if (chartKey.equals(ChartKeys.APV_WF_SV.toString())) {
                    ...
                    comp.addValue(result.get("org.bh.plugin.apv.APVCalculator$Result.PRESENT_VALUE_FCF")[0].getMin(),
                            ...
                            translator.translate("org.bh.plugin.apv.APVCalculator$Result.PRESENT_VALUE_FCF") + " " + translator.translate("min"));
                    comp.addValue(result.get("org.bh.plugin.apv.APVCalculator$Result.PRESENT_VALUE_FCF")[0].getMax() - result.get("org.bh.plugin.apv.APVCalculator$Result.PRESENT_VALUE_FCF")[0].getMin(),
                            translator.translate(ChartKeys.APV_WF_SV),
                            translator.translate("org.bh.plugin.apv.APVCalculator$Result.PRESENT_VALUE_FCF") + " " + translator.translate("max"));
                    comp.addValue(
                            result.get("org.bh.plugin.apv.APVCalculator$Result.PRESENT_VALUE_TAX_SHIELD")[0].getMin(),
                            translator.translate(ChartKeys.APV_WF_SV),
                            translator.translate("org.bh.plugin.apv.APVCalculator$Result.PRESENT_VALUE_TAX_SHIELD") + " " + translator.translate("min"));
                    comp.addValue(
                            result.get("org.bh.plugin.apv.APVCalculator$Result.PRESENT_VALUE_TAX_SHIELD")[0].getMax() - result.get("org.bh.plugin.apv.APVCalculator$Result.PRESENT_VALUE_TAX_SHIELD")[0].getMin(),
                            translator.translate(ChartKeys.APV_WF_SV),
                            translator.translate("org.bh.plugin.apv.APVCalculator$Result.PRESENT_VALUE_TAX_SHIELD") + " " + translator.translate("max"));
                    comp.addValue(
                            result.get("org.bh.calculation.IShareholderValueCalculator$Result.DEBT")[0].getMin() * -1, translator.translate(ChartKeys.APV_WF_SV),
                            translator.translate("org.bh.calculation.IShareholderValueCalculator$Result.DEBT") + " " + translator.translate("min"));
                    comp.addValue(
                            (result.get("org.bh.calculation.IShareholderValueCalculator$Result.DEBT")[0].getMax() - result.get("org.bh.calculation.IShareholderValueCalculator$Result.DEBT")[0].getMin()) * -1,
                            translator.translate(ChartKeys.APV_WF_SV),
                            translator.translate("org.bh.calculation.IShareholderValueCalculator$Result.DEBT") + " " + translator.translate("max"));
                    comp.addValue(
                            result.get("org.bh.calculation.IShareholderValueCalculator$Result.SHAREHOLDER_VALUE")[0].getMin() * -1,
                            translator.translate(ChartKeys.APV_WF_SV),
                            translator.translate("org.bh.calculation.IShareholderValueCalculator$Result.SHAREHOLDER_VALUE") + " " + translator.translate("min"));
                    comp.addValue(
                            result.get("org.bh.calculation.IShareholderValueCalculator$Result.SHAREHOLDER_VALUE")[0].getMax() - result.get("org.bh.calculation.IShareholderValueCalculator$Result.SHAREHOLDER_VALUE")[0].getMin(),
                            translator.translate(ChartKeys.APV_WF_SV),
                            translator.translate("org.bh.calculation.IShareholderValueCalculator$Result.SHAREHOLDER_VALUE") + " " + translator.translate("max"));
                    ...
                    for (int i = 0; i < length; i++) {
                        ...
                        comp.addValue(result.get("org.bh.plugin.apv.APVCalculator$Result.PRESENT_VALUE_FCF")[i].getMin(), translator.translate("org.bh.plugin.apv.APVCalculator$Result.PRESENT_VALUE_FCF") + " " + translator.translate("min"), name, IBHAddGroupValue.MIN_POS);
                        comp.addValue(result.get("org.bh.calculation.IShareholderValueCalculator$Result.DEBT")[i].getMin(), translator.translate("org.bh.calculation.IShareholderValueCalculator$Result.DEBT") + " " + translator.translate("min"), name, IBHAddGroupValue.MIN_POS);
                        comp.addValue(result.get("org.bh.plugin.apv.APVCalculator$Result.PRESENT_VALUE_FCF")[i].getMax(), translator.translate("org.bh.plugin.apv.APVCalculator$Result.PRESENT_VALUE_FCF") + " " + translator.translate("max"), name, IBHAddGroupValue.MAX_POS);
                        comp.addValue(result.get("org.bh.calculation.IShareholderValueCalculator$Result.DEBT")[i].getMax(), translator.translate("org.bh.calculation.IShareholderValueCalculator$Result.DEBT") + " " + translator.translate("max"), name, IBHAddGroupValue.MAX_POS);
                    ...
                    comp.addValue(
                            result.get("org.bh.plugin.fcf.FCFCalculator$Result.TOTAL_CAPITAL")[0].getMin(),
                            translator.translate(ChartKeys.FCF_WF_SV),
                            translator.translate("org.bh.plugin.fcf.FCFCalculator$Result.TOTAL_CAPITAL") + " " + translator.translate("min"));
                    comp.addValue(
                            result.get("org.bh.plugin.fcf.FCFCalculator$Result.TOTAL_CAPITAL")[0].getMax() - result.get("org.bh.plugin.fcf.FCFCalculator$Result.TOTAL_CAPITAL")[0].getMin(),
                            translator.translate(ChartKeys.FCF_WF_SV),
                            translator.translate("org.bh.plugin.fcf.FCFCalculator$Result.TOTAL_CAPITAL") + " " + translator.translate("max"));
                    comp.addValue(
                            result.get("org.bh.calculation.IShareholderValueCalculator$Result.DEBT")[0].getMin() * -1,
                            translator.translate(ChartKeys.FCF_WF_SV.toString()),
                            translator.translate("org.bh.calculation.IShareholderValueCalculator$Result.DEBT") + " " + translator.translate("min"));
                    comp.addValue(
                            result.get("org.bh.calculation.IShareholderValueCalculator$Result.DEBT")[0].getMax() * -1,
                            translator.translate(ChartKeys.FCF_WF_SV.toString()),
                            translator.translate("org.bh.calculation.IShareholderValueCalculator$Result.DEBT") + " " + translator.translate("max"));
                    comp.addValue(
                            result.get("org.bh.calculation.IShareholderValueCalculator$Result.SHAREHOLDER_VALUE")[0].getMin() * -1,
                    ...
                    if (result.get("org.bh.calculation.IShareholderValueCalculator$Result.FREE_CASH_FLOW")[0] != null) {
                        ...
                        comp.addValue(result.get("org.bh.calculation.IShareholderValueCalculator$Result.FREE_CASH_FLOW")[0].getMin(), translator.translate(ChartKeys.FCF_BC_FCF.toString()) + " " + translator.translate("min"), name);
                        comp.addValue(result.get("org.bh.calculation.IShareholderValueCalculator$Result.FREE_CASH_FLOW")[0].getMax(), translator.translate(ChartKeys.FCF_BC_FCF.toString()) + " " + translator.translate("max"), name);
                    }
                    for (int i = 1; i < scenario.getChildrenSize(); i++) {
                        String name = scenario.getChildren().get(i).get(DTOPeriod.Key.NAME).toString();
                        comp.addValue(result.get("org.bh.calculation.IShareholderValueCalculator$Result.FREE_CASH_FLOW")[i].getMin(), translator.translate(ChartKeys.FCF_BC_FCF.toString()) + " " + translator.translate("min"), name);
                        comp.addValue(result.get("org.bh.calculation.IShareholderValueCalculator$Result.FREE_CASH_FLOW")[i].getMax(), translator.translate(ChartKeys.FCF_BC_FCF.toString()) + " " + translator.translate("max"), name);
                    ...
                    for (int i = 0; i < scenario.getChildrenSize(); i++) {
                        String name = scenario.getChildren().get(i).get(DTOPeriod.Key.NAME).toString();
                        comp.addValue(result.get("org.bh.plugin.fcf.FCFCalculator$Result.EQUITY_RETURN_RATE_FCF")[i].getMin() * 100, translator.translate("org.bh.plugin.fcf.FCFCalculator$Result.EQUITY_RETURN_RATE_FCF") + " " + translator.translate("min"), name);
                        comp.addValue(result.get("org.bh.calculation.IShareholderValueCalculator$Result.DEBT_RETURN_RATE")[0].getMin() * 100, translator.translate("org.bh.calculation.IShareholderValueCalculator$Result.DEBT_RETURN_RATE") + " " + translator.translate("min"), name);
                        comp.addValue(result.get("org.bh.plugin.fcf.FCFCalculator$Result.EQUITY_RETURN_RATE_FCF")[i].getMax() * 100, translator.translate("org.bh.plugin.fcf.FCFCalculator$Result.EQUITY_RETURN_RATE_FCF") + " " + translator.translate("max"), name);
                        comp.addValue(result.get("org.bh.calculation.IShareholderValueCalculator$Result.DEBT_RETURN_RATE")[0].getMax() * 100, translator.translate("org.bh.calculation.IShareholderValueCalculator$Result.DEBT_RETURN_RATE") + " " + translator.translate("max"), name);
                    }
                    ...
                    for (int i = 1; i < scenario.getChildrenSize(); i++) {
                        String name = scenario.getChildren().get(i).get(DTOPeriod.Key.NAME).toString();
                        comp.addValue(result.get("org.bh.plugin.fte.FTECalculator$Result.FLOW_TO_EQUITY")[i].getMin(), translator.translate("org.bh.plugin.fte.FTECalculator$Result.FLOW_TO_EQUITY") + " " + translator.translate("min"), name);
                        comp.addValue(result.get("org.bh.plugin.fte.FTECalculator$Result.FLOW_TO_EQUITY")[i].getMax(), translator.translate("org.bh.plugin.fte.FTECalculator$Result.FLOW_TO_EQUITY") + " " + translator.translate("max"), name);
                    }
                    ...
                    for (int i = 1; i < scenario.getChildrenSize(); i++) {
                        String name = scenario.getChildren().get(i).get(DTOPeriod.Key.NAME).toString();
                        comp.addValue(result.get("org.bh.plugin.fte.FTECalculator$Result.EQUITY_RETURN_RATE_FTE")[i].getMin() * 100, translator.translate("org.bh.plugin.fte.FTECalculator$Result.EQUITY_RETURN_RATE_FTE") + " " + translator.translate("min"), name);
                        comp.addValue(((Calculable) scenario.get(DTOScenario.Key.RFK)).getMin() * 100, translator.translate("org.bh.calculation.IShareholderValueCalculator$Result.DEBT") + " " + translator.translate("min"), name);
                        comp.addValue(result.get("org.bh.plugin.fte.FTECalculator$Result.EQUITY_RETURN_RATE_FTE")[i].getMax() * 100, translator.translate("org.bh.plugin.fte.FTECalculator$Result.EQUITY_RETURN_RATE_FTE") + " " + translator.translate("max"), name);
                        comp.addValue(((Calculable) scenario.get(DTOScenario.Key.RFK)).getMax() * 100, translator.translate("org.bh.calculation.IShareholderValueCalculator$Result.DEBT") + " " + translator.translate("max"), name);
                    }
                }
            }
        } else {
            ...
            for (String chartKey : super.view.getBHchartComponents().keySet()) {
                ...
                if (chartKey.equals(ChartKeys.APV_WF_SV.toString())) {
                    ...
                    for (int i = 0; i < length; i++) {
                        String name = scenario.getChildren().get(i).get(DTOPeriod.Key.NAME).toString();
                        comp.addValue(result.get("org.bh.plugin.apv.APVCalculator$Result.PRESENT_VALUE_FCF")[i].parse(), translator.translate("org.bh.plugin.apv.APVCalculator$Result.PRESENT_VALUE_FCF"), name);
                        comp.addValue(result.get("org.bh.calculation.IShareholderValueCalculator$Result.DEBT")[i].parse(), translator.translate("org.bh.calculation.IShareholderValueCalculator$Result.DEBT"), name);
                    }
                    ...
                    if (result.get("org.bh.calculation.IShareholderValueCalculator$Result.FREE_CASH_FLOW")[0] != null) {
                        String name = scenario.getChildren().get(0).get(DTOPeriod.Key.NAME).toString();
                        comp.addValue(result.get("org.bh.calculation.IShareholderValueCalculator$Result.FREE_CASH_FLOW")[0].parse(), translator.translate(ChartKeys.FCF_BC_FCF.toString()), name);
                    }
                    for (int i = 1; i < scenario.getChildrenSize(); i++) {
                        String name = scenario.getChildren().get(i).get(DTOPeriod.Key.NAME).toString();
                        comp.addValue(result.get("org.bh.calculation.IShareholderValueCalculator$Result.FREE_CASH_FLOW")[i].parse(), translator.translate(ChartKeys.FCF_BC_FCF.toString()), name);
                    }
                    ...
                    for (int i = 0; i < scenario.getChildrenSize(); i++) {
                        String name = scenario.getChildren().get(i).get(DTOPeriod.Key.NAME).toString();
                        comp.addValue(result.get("org.bh.plugin.fcf.FCFCalculator$Result.EQUITY_RETURN_RATE_FCF")[i].parse().doubleValue() * 100, translator.translate("org.bh.plugin.fcf.FCFCalculator$Result.EQUITY_RETURN_RATE_FCF"), name);
                        comp.addValue(result.get("org.bh.calculation.IShareholderValueCalculator$Result.DEBT_RETURN_RATE")[0].parse().doubleValue() * 100, translator.translate("org.bh.calculation.IShareholderValueCalculator$Result.DEBT_RETURN_RATE"), name);
                    }
                }// Not necessary ct Pohl
                else if (chartKey.equals(ChartKeys.FTE_BC_SV.toString())) {
                    ...
                    for (int i = 1; i < scenario.getChildrenSize(); i++) {
                        String name = scenario.getChildren().get(i).get(DTOPeriod.Key.NAME).toString();
                        comp.addValue(result.get("org.bh.plugin.fte.FTECalculator$Result.FLOW_TO_EQUITY")[i].parse(), translator.translate("org.bh.plugin.fte.FTECalculator$Result.FLOW_TO_EQUITY"), name);
                    }
                    ...
                    for (int i = 0; i < scenario.getChildrenSize(); i++) {
                        String name = scenario.getChildren().get(i).get(DTOPeriod.Key.NAME).toString();
                        comp.addValue(result.get("org.bh.plugin.fte.FTECalculator$Result.PRESENT_VALUE_TAX_SHIELD")[i].parse(),
                                translator.translate("org.bh.plugin.fte.FTECalculator$Result.PRESENT_VALUE_TAX_SHIELD"), name);
                        comp.addValue(result.get("org.bh.calculation.IShareholderValueCalculator$Result.DEBT")[i].parse(),
                                translator.translate("org.bh.calculation.IShareholderValueCalculator$Result.DEBT"), name);
                    }
                } else if (chartKey.equals(ChartKeys.FTE_BC_RR.toString())) {
                    IBHAddValue comp = super.view.getBHchartComponents().get(ChartKeys.FTE_BC_RR.toString());
                    for (int i = 1; i < scenario.getChildrenSize(); i++) {
                        String name = scenario.getChildren().get(i).get(DTOPeriod.Key.NAME).toString();
                        comp.addValue(result.get("org.bh.plugin.fte.FTECalculator$Result.EQUITY_RETURN_RATE_FTE")[i].parse(), translator.translate("org.bh.plugin.fte.FTECalculator$Result.EQUITY_RETURN_RATE_FTE"), name);
                        comp.addValue(result.get("org.bh.calculation.IShareholderValueCalculator$Result.DEBT")[i].parse(), translator.translate("org.bh.calculation.IShareholderValueCalculator$Result.DEBT"), name);
                    }
                }
            }
...
// General
    ...
    BHFormulaPanel initFormulaPanel(DTOScenario scenario) {
        ...
        fPanel =
                new BHFormulaPanel(this);
        for (int i = 0; i <
                scenario.getChildrenSize(); i++) {
            fPanel.addEntry("T" + i);
        }
