...
public class BHPLSTotalCostForm extends JPanel {
	...
	if (!intervalArithmetic) {
	    ...
	    this.add(new JLabel(translator.translate("currency")), cons.xywh(12, 2, 1, 1));
	    this.add(this.getTfPA(), cons.xywh(10, 4, 1, 1));
	    this.add(new JLabel(translator.translate("currency")), cons.xywh(12, 4, 1, 1));
	    this.add(this.getTfABSCH(), cons.xywh(10, 6, 1, 1));
	    this.add(new JLabel(translator.translate("currency")), cons.xywh(12, 6, 1, 1));
	    ...
	    this.add(new JSeparator(SwingConstants.VERTICAL), cons.xywh(8, 2, 1, 5));

	    layout.insertRow(8, RowSpec.decode("10px"));
	    layout.insertRow(9, RowSpec.decode("4px"));
	    this.add(new JSeparator(SwingConstants.HORIZONTAL), cons.xywh(2, 8, 13, 1));
	    ...
	    this.add(new JLabel(translator.translate("min")), cons.xywh(14, 2, 1, 1, "center,default"));
	    this.add(new JLabel(translator.translate("max")), cons.xywh(18, 2, 1, 1, "center,default"));
	    ...
	    this.add(new JLabel(translator.translate("currency")), cons.xywh(16, 4, 1, 1));

	    this.add(this.getTfPAmin(), cons.xywh(14, 6, 1, 1));
	    this.add(new JLabel(translator.translate("currency")), cons.xywh(16, 6, 1, 1));

	    this.add(this.getTfABSCHmin(), cons.xywh(14, 8, 1, 1));
	    this.add(new JLabel(translator.translate("currency")), cons.xywh(16, 8, 1, 1));

	    this.add(this.getTfSBAmin(), cons.xywh(4, 10, 1, 1));
	    this.add(new JLabel(translator.translate("currency")), cons.xywh(6, 10, 1, 1));

	    this.add(this.getTfZAmin(), cons.xywh(4, 12, 1, 1));
	    this.add(new JLabel(translator.translate("currency")), cons.xywh(6, 12, 1, 1));
	    ...
	    this.add(new JLabel(translator.translate("currency")), cons.xywh(20, 4, 1, 1));

	    this.add(this.getTfPAmax(), cons.xywh(18, 6, 1, 1));
	    this.add(new JLabel(translator.translate("currency")), cons.xywh(20, 6, 1, 1));

	    this.add(this.getTfABSCHmax(), cons.xywh(18, 8, 1, 1));
	    this.add(new JLabel(translator.translate("currency")), cons.xywh(20, 8, 1, 1));
	    ...
	    this.add(new JLabel(translator.translate("currency")), cons.xywh(10, 12, 1, 1));

	    layout.insertColumn(12, ColumnSpec.decode("10px"));
	    layout.insertColumn(13, ColumnSpec.decode("4px"));
	    this.add(new JSeparator(SwingConstants.VERTICAL), cons.xywh(12, 4, 1, 5));

	    layout.insertRow(10, RowSpec.decode("10px"));
	    layout.insertRow(11, RowSpec.decode("4px"));
	    this.add(new JSeparator(SwingConstants.HORIZONTAL), cons.xywh(2, 10, 21, 1));
	...
	this.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(EtchedBorder.LOWERED), translator.translate(BHPLSTotalCostForm.Key.PLS_TotalCost)));
    }
	...
	if (tfUE == null) {
	    ...
	    ValidationRule[] rules = { VRMandatory.INSTANCE, VRIsDouble.INSTANCE };
	...
	if (tfABSCH == null) {
	    tfABSCH = new BHTextField(DTOGCCProfitLossStatementTotalCost.Key.ABSCH);
	    ValidationRule[] rules = { VRMandatory.INSTANCE, VRIsDouble.INSTANCE };
	...
	if (tfUEmax == null) {
	    tfUEmax = new BHTextField(IBHComponent.MAXVALUE + DTOGCCProfitLossStatementTotalCost.Key.UE);
	    ValidationRule[] rules = { VRMandatory.INSTANCE, VRIsDouble.INSTANCE, new VRIsGreaterThan(getTfUEmin(), true) };
	...
	if (tfABSCHmax == null) {
	    tfABSCHmax = new BHTextField(IBHComponent.MAXVALUE + DTOGCCProfitLossStatementTotalCost.Key.ABSCH);
	    ValidationRule[] rules = { VRMandatory.INSTANCE, VRIsDouble.INSTANCE, new VRIsGreaterThan(getTfABSCHmin(), true) };
	...
	if (tfSBAmax == null) {
	    tfSBAmax = new BHTextField(IBHComponent.MAXVALUE + DTOGCCProfitLossStatementTotalCost.Key.SBA);
	    ValidationRule[] rules = { VRMandatory.INSTANCE, VRIsDouble.INSTANCE, new VRIsGreaterThan(getTfSBAmin(), true) };
	...
	if (tfSBEmax == null) {
	    tfSBEmax = new BHTextField(IBHComponent.MAXVALUE + DTOGCCProfitLossStatementTotalCost.Key.SBE);
	    ValidationRule[] rules = { VRMandatory.INSTANCE, VRIsDouble.INSTANCE, new VRIsGreaterThan(getTfSBEmin(), true) };
	...
	if (tfAAEmax == null) {
	    tfAAEmax = new BHTextField(IBHComponent.MAXVALUE + DTOGCCProfitLossStatementTotalCost.Key.AAE);
	    ValidationRule[] rules = { VRMandatory.INSTANCE, VRIsDouble.INSTANCE, new VRIsGreaterThan(getTfAAEmin(), true) };
	...
	if (tfPAmax == null) {
	    tfPAmax = new BHTextField(IBHComponent.MAXVALUE + DTOGCCProfitLossStatementTotalCost.Key.PA);
	    ValidationRule[] rules = { VRMandatory.INSTANCE, VRIsDouble.INSTANCE, new VRIsGreaterThan(getTfPAmin(), true) };
	...
	if (tfMAmax == null) {
	    tfMAmax = new BHTextField(IBHComponent.MAXVALUE + DTOGCCProfitLossStatementTotalCost.Key.MA);
	    ValidationRule[] rules = { VRMandatory.INSTANCE, VRIsDouble.INSTANCE, new VRIsGreaterThan(getTfMAmin(), true) };
	...
	if (tfZAmax == null) {
	    tfZAmax = new BHTextField(IBHComponent.MAXVALUE + DTOGCCProfitLossStatementTotalCost.Key.ZA);
	    ValidationRule[] rules = { VRMandatory.INSTANCE, VRIsDouble.INSTANCE, new VRIsGreaterThan(getTfZAmin(), true) };
	...
	if (tfUEmin == null) {
	    tfUEmin = new BHTextField(IBHComponent.MINVALUE + DTOGCCProfitLossStatementTotalCost.Key.UE);
	    ValidationRule[] rules = { VRMandatory.INSTANCE, VRIsDouble.INSTANCE };
	...
	if (tfABSCHmin == null) {
	    tfABSCHmin = new BHTextField(IBHComponent.MINVALUE + DTOGCCProfitLossStatementTotalCost.Key.ABSCH);
	    ValidationRule[] rules = { VRMandatory.INSTANCE, VRIsDouble.INSTANCE };
	...
	if (tfSBAmin == null) {
	    tfSBAmin = new BHTextField(IBHComponent.MINVALUE + DTOGCCProfitLossStatementTotalCost.Key.SBA);
	    ValidationRule[] rules = { VRMandatory.INSTANCE, VRIsDouble.INSTANCE };
	...
	if (tfSBEmin == null) {
	    tfSBEmin = new BHTextField(IBHComponent.MINVALUE + DTOGCCProfitLossStatementTotalCost.Key.SBE);
	    ValidationRule[] rules = { VRMandatory.INSTANCE, VRIsDouble.INSTANCE };
	...
	if (tfAAEmin == null) {
	    tfAAEmin = new BHTextField(IBHComponent.MINVALUE + DTOGCCProfitLossStatementTotalCost.Key.AAE);
	    ValidationRule[] rules = { VRMandatory.INSTANCE, VRIsDouble.INSTANCE };
	...
	if (tfPAmin == null) {
	    tfPAmin = new BHTextField(IBHComponent.MINVALUE + DTOGCCProfitLossStatementTotalCost.Key.PA);
	    ValidationRule[] rules = { VRMandatory.INSTANCE, VRIsDouble.INSTANCE };
	...
	if (tfMAmin == null) {
	    tfMAmin = new BHTextField(IBHComponent.MINVALUE + DTOGCCProfitLossStatementTotalCost.Key.MA);
	    ValidationRule[] rules = { VRMandatory.INSTANCE, VRIsDouble.INSTANCE };
	...
	if (tfZAmin == null) {
	    tfZAmin = new BHTextField(IBHComponent.MINVALUE + DTOGCCProfitLossStatementTotalCost.Key.ZA);
	    ValidationRule[] rules = { VRMandatory.INSTANCE, VRIsDouble.INSTANCE };
	...
	if (lSBE == null) {
	    lSBE = new BHDescriptionLabel(DTOGCCProfitLossStatementTotalCost.Key.SBE);
	}
	return lSBE;
    }
	...
	if (lMA == null) {
	    lMA = new BHDescriptionLabel(DTOGCCProfitLossStatementTotalCost.Key.MA);
	}
	return lMA;
    }
	...
	if (lPA == null) {
	    lPA = new BHDescriptionLabel(DTOGCCProfitLossStatementTotalCost.Key.PA);
	}
	return lPA;
    }
	...
	if (lAAE == null) {
	    lAAE = new BHDescriptionLabel(DTOGCCProfitLossStatementTotalCost.Key.AAE);
	}
	return lAAE;
    }
	...
	if (lZA == null) {
	    lZA = new BHDescriptionLabel(DTOGCCProfitLossStatementTotalCost.Key.ZA);
	}
	return lZA;
    }
