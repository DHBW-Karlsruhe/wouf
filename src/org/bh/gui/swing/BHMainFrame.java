...
public class BHMainFrame extends JFrame {
    ...
    public BHMainFrame(String title) {
        ...
        //treeBar.setBounds(0, standardBarHeight, treeBarWidth, screenSize.height-standardBarHeight);
        //treeBar.setBounds(0,200,200,400); 
              
        statusBar = new BHStatusBar("");
        content = new BHContent();
        
        //Create the horizontal split pane and put the treeBar and the content in it.
