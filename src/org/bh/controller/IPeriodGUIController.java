 ...
 *
 */
public interface IPeriodGUIController {
	/**
	 * This method is called by the platform whenever it needs DTOs for
	 * a specific period.
	 * 
	 * <p>
	 * The <code>dto</code> parameter contains a reference to the DTO for
	 * this period. It's up to the controller to remove any existing child DTOs.
	 * 
	 * <p>
	 ...
	 * 
	 * @param dto The DTO of the period.
	 * @param panel Panel for the view.
	 * @see #stopEditing()
	 */
	...
	/**
	 * Defines the description of the controller which will be displayed at the GUI.
	 * @return Translation key for the description.
	 */
	String getGuiKey();
	
	/**
	 * Defines the priority. This is used to sort the controllers before displaying
	 * them at the GUI. The controller with the highest priority will be displayed first.
